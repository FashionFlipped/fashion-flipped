...
const Landing = () => {
  ...
  <div class="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
    <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
      ...
      Battle fast fashion and the gentrification of thrift stores with FashionFlipped! We partner with upcyclers to create curated thrifts for our users at a cheap cost. <br></br><br></br>Ready to elevate your style?
      
      <div class="action">
        <button class="action-button" href = "/profile">Get started</button>
        </div>
  ...
  <div class="relative grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-4 sm:grid-cols-2">
    ...
    <div class="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
      ...
      <p class="text-sm text-gray-900">
        Create a 1 minute profile: select images that describe your fashion sense
      </p>
    </div>
    <div class="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
      <div class="flex items-center justify-between mb-2">
  ...
  <div class="max-w-xl sm:mx-auto lg:max-w-2xl">
    <div class="flex flex-col mb-16 sm:text-center">
      ...
      <div class="max-w-xl md:mx-auto sm:text-center lg:max-w-2xl">
        ...
        <p class="text-base text-gray-700 md:text-lg">Question not on the list? Contact us at FashionFlipped@gmail.com with your inquiry :)</p>
      </div>
    </div>
    <div class="space-y-4">
      <div class="border rounded shadow-sm">
        <button type="button" aria-label="Open item" title="Open item" class="flex items-center justify-between w-full p-4 focus:outline-none">
          <p class="text-lg font-medium">When will I recieve my package?</p>
        ...
        <div class="p-4 pt-0"><p class="text-gray-700">We announce the drop day 24 hours before you will recieve your package. Use the hashtags #FashionFlipped #Drop Day to share your haul! on social media!</p></div>
      </div>
      <div class="border rounded shadow-sm">
        <button type="button" aria-label="Open item" title="Open item" class="flex items-center justify-between w-full p-4 focus:outline-none">
          <p class="text-lg font-medium">How do you select FashionFlipped designers?</p>
          <div class="flex items-center justify-center w-8 h-8 border rounded-full">
            <svg viewBox="0 0 24 24" class="w-3 text-gray-600 transition-transform duration-200">
              <polyline fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-miterlimit="10" points="2,7 12,17 22,7" stroke-linejoin="round"></polyline>
            </svg>
        ...
        <div class="p-4 pt-0"><p class="text-gray-700">Designers go through a vetting process handled by our in-house fashion team to ensure quality and creativity in their designs. If you are ever unhappy with your package, please let us know and we will issue a full refund for your package.</p></div>
      </div>
      <div class="border rounded shadow-sm">
        <button type="button" aria-label="Open item" title="Open item" class="flex items-center justify-between w-full p-4 focus:outline-none">
          <p class="text-lg font-medium">How can I upgrade my subscription?</p>
          <div class="flex items-center justify-center w-8 h-8 border rounded-full">
            <svg viewBox="0 0 24 24" class="w-3 text-gray-600 transition-transform duration-200">
              <polyline fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-miterlimit="10" points="2,7 12,17 22,7" stroke-linejoin="round"></polyline>
            </svg>
        ...
        <div class="p-4 pt-0"><p class="text-gray-700">After you recieve your monthly package, you can switch your subscription!</p></div>
      </div>
      <div class="border rounded shadow-sm">
        <button type="button" aria-label="Open item" title="Open item" class="flex items-center justify-between w-full p-4 focus:outline-none">
          <p class="text-lg font-medium">How can I share feedback with the FashionFlipped Team?</p>
          <div class="flex items-center justify-center w-8 h-8 border rounded-full">
            <svg viewBox="0 0 24 24" class="w-3 text-gray-600 transition-transform duration-200">
              <polyline fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-miterlimit="10" points="2,7 12,17 22,7" stroke-linejoin="round"></polyline>
            </svg>
        ...
        <div class="p-4 pt-0"><p class="text-gray-700">We always love to hear ways we could continue to improve our product from our users like you! Send an email to us at FashionFlipped@gmail.com!</p></div>
      </div>
    </div>
  </div>
</div>
